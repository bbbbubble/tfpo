...
export const ClosingScene: React.FC = () => {
  ...
  return <SceneShell id="closing" label="Takeaway" title="Preference alignment is token-level credit assignment.">
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 70, alignItems: 'center', height: '100%' }}>
      <p style={{ margin: 0, maxWidth: 720, fontFamily: fonts.serif, fontSize: 45, lineHeight: 1.38 }}>Do not only ask <em>which objectives</em> to mix. Ask <span style={{ color: colors.rust, textDecoration: 'underline', textDecorationColor: colors.teal, textUnderlineOffset: 10 }}>where each objective should act</span>.</p>
      <div>
